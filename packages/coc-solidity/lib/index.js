...
const logger = __webpack_require__(7)('workspace');
console.log = (...args) => {
    logger.info(...args);
};
...
const log4js_1 = tslib_1.__importDefault(__webpack_require__(10));
const path_1 = tslib_1.__importDefault(__webpack_require__(25));
const os_1 = tslib_1.__importDefault(__webpack_require__(19));
function getLogFile() {
 ...
 */
const debug = __webpack_require__(11)("log4js:main");
const fs = __webpack_require__(9);
const deepClone = __webpack_require__(21)({ proto: true });
const configuration = __webpack_require__(22);
const layouts = __webpack_require__(23);
const levels = __webpack_require__(26);
const appenders = __webpack_require__(27);
const categories = __webpack_require__(97);
const Logger = __webpack_require__(98);
const clustering = __webpack_require__(28);
const connectLogger = __webpack_require__(99);
...
const util = __webpack_require__(17);
const debug = __webpack_require__(11)('log4js:configuration');
...
const dateFormat = __webpack_require__(24);
const os = __webpack_require__(19);
const util = __webpack_require__(17);
...
const path = __webpack_require__(25);
const debug = __webpack_require__(11)('log4js:appenders');
const configuration = __webpack_require__(22);
const clustering = __webpack_require__(28);
const levels = __webpack_require__(26);
const layouts = __webpack_require__(23);
...
coreAppenders.set('console', __webpack_require__(33));
coreAppenders.set('stdout', __webpack_require__(34));
coreAppenders.set('stderr', __webpack_require__(35));
coreAppenders.set('logLevelFilter', __webpack_require__(36));
coreAppenders.set('categoryFilter', __webpack_require__(37));
coreAppenders.set('noLogFilter', __webpack_require__(38));
coreAppenders.set('file', __webpack_require__(39));
coreAppenders.set('dateFile', __webpack_require__(95));
...
const tryLoading = (modulePath, config) => {
  ...
  try {
    return __webpack_require__(96)(modulePath); //eslint-disable-line
  } catch (e) {
...
const createAppender = (name, config) => {
  ...
  debug(`${name}: appenderModule is ${__webpack_require__(17).inspect(appenderModule)}`); // eslint-disable-line
...
const debug = __webpack_require__(11)("log4js:clustering");
const LoggingEvent = __webpack_require__(29);
const configuration = __webpack_require__(22);

let disabled = false;
let cluster = null;
try {
  cluster = __webpack_require__(31); //eslint-disable-line
} catch (e) {
...
const flatted = __webpack_require__(30);
const levels = __webpack_require__(26);
...
const debug = __webpack_require__(11)('log4js:categoryFilter');
...
const debug = __webpack_require__(11)('log4js:noLogFilter');
...
const debug = __webpack_require__(11)('log4js:file');
const path = __webpack_require__(25);
const streams = __webpack_require__(40);
const os = __webpack_require__(19);
...
module.exports = {
  RollingFileWriteStream: __webpack_require__(41),
  RollingFileStream: __webpack_require__(93),
  DateRollingFileStream: __webpack_require__(94)
};
...
const debug = __webpack_require__(42)("streamroller:RollingFileWriteStream");
const fs = __webpack_require__(47);
const path = __webpack_require__(25);
const newNow = __webpack_require__(88);
const format = __webpack_require__(24);
const { Writable } = __webpack_require__(54);
const fileNameFormatter = __webpack_require__(89);
const fileNameParser = __webpack_require__(90);
const moveAndMaybeCompressFile = __webpack_require__(91);
...
const u = __webpack_require__(49).fromCallback
...
if (!fs[gracefulQueue]) {
  ...
  if (/\bgfs4\b/i.test(process.env.NODE_DEBUG || '')) {
    process.on('exit', function() {
      ...
      __webpack_require__(56).equal(fs[gracefulQueue].length, 0)
    })
  }
}
...
const utimesSync = __webpack_require__(63).utimesMillisSync
...
function copyFileFallback (srcStat, src, dest, opts) {
  ...
  const _buff = __webpack_require__(65)(BUF_LENGTH)
...
const u = __webpack_require__(49).fromCallback
const mkdirs = u(__webpack_require__(60))
const mkdirsSync = __webpack_require__(62)
...
const fs = __webpack_require__(50)
const path = __webpack_require__(25)
const invalidWin32Path = __webpack_require__(61).invalidWin32Path
...
const pathExists = __webpack_require__(68).pathExists
const utimes = __webpack_require__(63).utimesMillis
const stat = __webpack_require__(64)
...
const u = __webpack_require__(49).fromPromise
...
const u = __webpack_require__(49).fromCallback
const rimraf = __webpack_require__(71)
...
const file = __webpack_require__(73)
const link = __webpack_require__(74)
const symlink = __webpack_require__(75)
...
const _symlinkPaths = __webpack_require__(76)
const symlinkPaths = _symlinkPaths.symlinkPaths
const symlinkPathsSync = _symlinkPaths.symlinkPathsSync

const _symlinkType = __webpack_require__(77)
...
jsonFile.outputJsonSync = __webpack_require__(82)
// aliases
...
module.exports = {
  moveSync: __webpack_require__(84)
}
...
const fs = __webpack_require__(50)
const path = __webpack_require__(25)
const copySync = __webpack_require__(57).copySync
...
const fs = __webpack_require__(50)
const path = __webpack_require__(25)
const copy = __webpack_require__(66).copy
...
const debug = __webpack_require__(42)("streamroller:fileNameFormatter");
const path = __webpack_require__(25);
const FILENAME_SEP = ".";
const ZIP_EXT = ".gz";
...
const debug = __webpack_require__(42)("streamroller:fileNameParser");
const FILENAME_SEP = ".";
const ZIP_EXT = ".gz";
const format = __webpack_require__(24);
...
const debug = __webpack_require__(42)('streamroller:moveAndMaybeCompressFile');
const fs = __webpack_require__(47);
...
const RollingFileWriteStream = __webpack_require__(41);
...
const debug = __webpack_require__(11)('log4js:categories');
const configuration = __webpack_require__(22);
const levels = __webpack_require__(26);
const appenders = __webpack_require__(27);
...
const debug = __webpack_require__(11)("log4js:logger");
const LoggingEvent = __webpack_require__(29);
const levels = __webpack_require__(26);
const clustering = __webpack_require__(28);
const categories = __webpack_require__(97);
...
(function() {
  ...
  composer = this.composer = __webpack_require__(102);

  constructor = this.constructor = __webpack_require__(106);

  dumper = this.dumper = __webpack_require__(108);

  errors = this.errors = __webpack_require__(104);

  events = this.events = __webpack_require__(103);

  loader = this.loader = __webpack_require__(113);

  nodes = this.nodes = __webpack_require__(105);

  parser = this.parser = __webpack_require__(117);

  reader = this.reader = __webpack_require__(114);

  resolver = this.resolver = __webpack_require__(112);

  scanner = this.scanner = __webpack_require__(115);

  tokens = this.tokens = __webpack_require__(116);
...
(function() {
  ...
  MarkedYAMLError = __webpack_require__(104).MarkedYAMLError;

  nodes = __webpack_require__(105);
...
(function() {
  ...
  this.inspect = (ref = (ref1 = (ref2 = __webpack_require__(17)) != null ? ref2.inspect : void 0) != null ? ref1 : global.inspect) != null ? ref : function(a) {
    return "" + a;
  };
...
(function() {
  ...
  representer = __webpack_require__(111);

  resolver = __webpack_require__(112);
...
(function() {
  ...
  YAMLError = __webpack_require__(104).YAMLError;
...
(function() {
  ...
  reader = __webpack_require__(114);

  scanner = __webpack_require__(115);

  parser = __webpack_require__(117);

  composer = __webpack_require__(102);

  resolver = __webpack_require__(112);

  constructor = __webpack_require__(106);
...
(function() {
  ...
  ref = __webpack_require__(104), Mark = ref.Mark, YAMLError = ref.YAMLError;
...
(function() {
  ...
  tokens = __webpack_require__(116);
